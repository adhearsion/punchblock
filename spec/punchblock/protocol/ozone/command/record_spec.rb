      ...
      module Command
        describe Record do
          it 'registers itself' do
            OzoneNode.class_from_registration(:record, 'urn:xmpp:ozone:record:1').should == Record
          end
          ...
          describe "actions" do
            ...
            describe '#pause_action' do
              ...
              its(:to_xml) { should == '<pause xmlns="urn:xmpp:ozone:record:1"/>' }
            ...
            describe '#resume_action' do
              ...
              its(:to_xml) { should == '<resume xmlns="urn:xmpp:ozone:record:1"/>' }
              its(:command_id) { should == 'abc123' }
              its(:call_id) { should == '123abc' }
            end
            ...
            describe '#stop_action' do
              ...
              its(:to_xml) { should == '<stop xmlns="urn:xmpp:ozone:record:1"/>' }
              its(:command_id) { should == 'abc123' }
              its(:call_id) { should == '123abc' }
            end
