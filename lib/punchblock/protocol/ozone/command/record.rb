    ...
    class Ozone
      module Command
        class Record < CommandNode
          ...
          ##
          # Creates an Ozone Record command
          #
          # @param [Hash] options
          ...
          #
          # @return [Ozone::Command::Record] an Ozone "record" command
          #
          # @example
          #   record :text => 'Hello brown cow.'
          #
          #   returns:
          #     <record xmlns="urn:xmpp:ozone:record:1">Hello brown cow.</record>
          #
          ...
          #
          # @return [Ozone::Command::Record::Pause] an Ozone pause message for the current Record
          #
          # @example
          #    record_obj.pause_action.to_xml
          #
          #    returns:
          #      <pause xmlns="urn:xmpp:ozone:record:1"/>
          def pause_action
            Pause.new :command_id => command_id, :call_id => call_id
          end

          ##
          # Sends an Ozone pause message for the current Record
          #
          def pause!
          ...
          ##
          # Create an Ozone resume message for the current Record
          #
          # @return [Ozone::Command::Record::Resume] an Ozone resume message
          #
          # @example
          #    record_obj.resume_action.to_xml
          #
          #    returns:
          #      <resume xmlns="urn:xmpp:ozone:record:1"/>
          def resume_action
            Resume.new :command_id => command_id, :call_id => call_id
          end

          ##
          # Sends an Ozone resume message for the current Record
          #
          def resume!
          ...
          ##
          # Creates an Ozone stop message for the current Record
          #
          # @return [Ozone::Command::Record::Stop] an Ozone stop message
          #
          # @example
          #    record_obj.stop_action.to_xml
          #
          #    returns:
          #      <stop xmlns="urn:xmpp:ozone:record:1"/>
          def stop_action
            Stop.new :command_id => command_id, :call_id => call_id
          end

          ##
          # Sends an Ozone stop message for the current Record
          #
          def stop!
