...
shared_examples_for 'command_headers' do
  it 'takes a hash of keys and values for headers' do
    ...
    control = [ Punchblock::Rayo::Header.new(:x_skill, 'agent'), Punchblock::Rayo::Header.new(:x_customer_id, '8877')]
...
shared_examples_for 'event_headers' do
  its(:headers) { should == [Punchblock::Rayo::Header.new(:x_skill, 'agent'), Punchblock::Rayo::Header.new(:x_customer_id, '8877')]}
