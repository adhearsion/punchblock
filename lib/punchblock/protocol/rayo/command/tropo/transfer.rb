      ...
      module Command
        module Tropo
          class Transfer < CommandNode
            ...
            #
            # @return [Rayo::Message::Transfer] an Rayo "transfer" message
            #
            # @example
            ...
            class Complete
              ...
              class Timeout < Rayo::Event::Complete::Reason
              ...
              class Busy < Rayo::Event::Complete::Reason
                register :busy, :transfer_complete
              end

              class Reject < Rayo::Event::Complete::Reason
